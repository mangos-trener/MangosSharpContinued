...
public class CreatureAI_Targorr_the_Dread : WS_Creatures_AI.BossAI
{
    ...
    public CreatureAI_Targorr_the_Dread(ILogger<BossAI> logger, WorldState worldState, WS_Maps maps, WS_Loot loot, WS_Creatures creatures, WS_Combat combat, ref WS_Creatures.CreatureObject Creature)
