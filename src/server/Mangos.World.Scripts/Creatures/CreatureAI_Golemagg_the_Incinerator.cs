...
public class CreatureAI_Golemagg_the_Incinerator : WS_Creatures_AI.BossAI
{
    ...
    public CreatureAI_Golemagg_the_Incinerator(ILogger<BossAI> logger, WorldState worldState, WS_Maps maps, WS_Loot loot, WS_Creatures creatures, WS_Combat combat, ref WS_Creatures.CreatureObject Creature)
